...
class EmpleadoView(tk.Frame):
    ...
    def frame_tablaEmpleado(self, where=""):
        ...
        if not hasattr(self, 'formulario_frame'):
            ...
            self.lblHoras = tk.Label(self.formulario_frame, text='Horas Trabajadas')
            self.lblHoras.config(font=('Arial', 15, 'bold'), bg='#BBBBBB')
            self.lblHoras.grid(column=0, row=7, padx=10, pady=5)

            self.lblFecha = tk.Label(self.formulario_frame, text='Fecha de contratación')
            self.lblFecha.config(font=('Arial', 15, 'bold'), bg='#BBBBBB')
            self.lblFecha.grid(column=0, row=8, padx=10, pady=5)

            self.lblCargo = tk.Label(self.formulario_frame, text='Codigo del cargo')
            self.lblCargo.config(font=('Arial', 15, 'bold'), bg='#BBBBBB')
            self.lblCargo.grid(column=0, row=9, padx=10, pady=5)
            ...
            self.entryHoras = tk.Entry(self.formulario_frame, textvariable=self.svHoras)
            self.entryHoras.config(width=40, font=('Arial', 15))
            self.entryHoras.grid(column=1, row=7, padx=10, pady=5, columnspan=2)
            ...
            self.entryFecha.grid(column=1, row=8, padx=10, pady=5, columnspan=2)

            self.boxCargo = ttk.Combobox(self.formulario_frame, state='readonly')
            self.boxCargo.config(width=40, font=('Arial', 12))
            self.boxCargo.grid(column=1, row=9, padx=10, pady=5, columnspan=2)
