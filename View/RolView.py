...
class RolView(tk.Frame):
    ...
    def frame_tablaRoles(self, where=""):
        ...
        if not hasattr(self, 'formulario_frame'):
            ...
            self.entruNombreRol.config(width=40, font=('ARIAL',15))
            ...
            self.entrySalario.config(width=40, font=('ARIAL',15))
